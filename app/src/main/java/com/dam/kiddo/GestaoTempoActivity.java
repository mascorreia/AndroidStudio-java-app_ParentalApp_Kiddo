...
public class GestaoTempoActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(GestaoTempoActivity.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth);
                LayoutInflater inflater = GestaoTempoActivity.this.getLayoutInflater();
